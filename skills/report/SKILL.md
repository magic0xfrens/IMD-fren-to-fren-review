...
forge test --match-path 'test/fren-review/*/*' -vvv       # every hunter's Repro test, with traces
```
...
## Summary
<3–6 lines: what was tested, how many findings by severity, the single most important thing>
...
- **Probe:** <actor, capital, preconditions, sequence>
- **Impact:** <numbers from the Repro test: who loses what, what the outsider nets>
